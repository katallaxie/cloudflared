...
## Docker Hub Image:
  https://hub.docker.com/r/katallaxie/cloudflared
...
```bash
docker pull katallaxie/cloudflared:latest
```
...
Example command:
```bash
/container/add remote-image=katallaxie/cloudflared:latest interface=veth1 root-dir=disk1/images/cloudflared envlist=TUNNEL_TOKEN name=cloudflared
```
---
